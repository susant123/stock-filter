...
const buybackDetails = require("./buybackDetails");

const nseBaseURL = "https://www.nseindia.com/";
const nseURL = "https://www.nseindia.com/api/equity-stockIndices?index=NIFTY%20500"; //NSE500 url
    ...
    try {
        ...
        axios
            ...
            .then((res) => {
                ...
                fs.writeFile(__dirname + "/data/nse500.json", JSON.stringify(convertedObj), (err) => {
                    if (err) {
                        console.log("Error Found:", err);
                    } else {
                        console.log("nse500.json was copied to nse500-old.json");
...
buybackDetails.startBuildingNSEPriceData("active-buyback");
buybackDetails.startBuildingNSEPriceData("forthcoming-buyback");
