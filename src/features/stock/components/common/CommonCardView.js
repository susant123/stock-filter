...
function CommonCardView(props) {
    ...
    const marketCap =
        nseData.priceInfo?.lastPrice && nseData.securityInfo && nseData.securityInfo.issuedSize !== "-"
    ...
    return (
        <>
            ...
            <StockName>
                ...
                {nseData?.metadata?.industry?.toLowerCase()})
            </StockName>
            <StockName>
            ...
            <StockName
                isDanger={nseData?.securityInfo?.surveillance.surv && nseData?.securityInfo?.surveillance.surv !== "-"}
            >
